    ...
    if (s_theFrameBuffer) {
        ...
        if (!fb->m_subWin) {
            ...
            if (fb->m_subWin) {
                ...
                printf("eglCreateWindowSurface begin\n");
                fb->m_eglSurface = s_egl.eglCreateWindowSurface(fb->m_eglDisplay,
                                                    fb->m_eglConfig,
                                                    fb->m_subWin,
                                                    NULL);
                printf("eglCreateWindowSurface end\n");
                                          ...
                                          GLenum p_internalFormat)
{
    ...
    //ERR("%s: createColorBuffer %d,%d,%d,%d\n", __FUNCTION__, p_width, p_height, (int)p_internalFormat,(int)ret);
    return ret;
}
        ...
        if (ret) {
            ...
            if (m_fpsStats) {
                ...
                if (currTime - m_statsStartTime >= 1000) {
                    ...
                    printf("FPS: %5.3f %5.5f \n", (float)m_statsNumFrames / dt,dt);

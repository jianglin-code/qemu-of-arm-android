...
typedef void (GL_APIENTRY *glGetClipPlanef_t) (GLenum, GLfloat eqn[4]);
...
typedef void (GL_APIENTRY *glGetClipPlanex_t) (GLenum, GLfixed eqn[4]);
...
typedef void (GL_APIENTRY *glGetClipPlanexOES_t) (GLenum, GLfixed eqn[4]);
...
typedef GLbitfield (GL_APIENTRY *glQueryMatrixxOES_t) (GLfixed mantissa[16], GLint exponent[16]);
...
typedef void (GL_APIENTRY *glGetClipPlanefOES_t) (GLenum, GLfloat eqn[4]);
